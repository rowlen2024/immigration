...
<style scoped>
.lawyer-thumb { width: 56px; height: 64px; object-fit: cover; border-radius: var(--radius-sm); }
.no-photo { color: var(--color-text-muted); }
