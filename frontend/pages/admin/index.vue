<template>
  <div>
    <h2 class="admin-page-title">控制台</h2>
    ...
    <div class="admin-stat-grid">
      <div class="admin-stat-card" v-for="card in statCards" :key="card.label">
        <div class="admin-stat-top">
          ...
          <span class="admin-stat-icon" :style="{ background: card.bg }" v-html="card.icon"></span>
        </div>
...
const statCards = computed(() => [
  {
    ...
    icon: getIconSvg('folder', 20, '#3b82f6'),
    bg: '#dbeafe',
  ...
  },
  {
    ...
    icon: getIconSvg('messages-square', 20, '#d97706'),
    bg: '#fef3c7',
  ...
  },
  {
    ...
    icon: getIconSvg('file-text', 20, '#16a34a'),
    bg: '#dcfce7',
  ...
  },
  {
    ...
    icon: getIconSvg('shield', 20, '#8b5cf6'),
    bg: '#ede9fe',
  ...
  },
  {
    ...
    icon: getIconSvg('bell', 20, '#dc2626'),
    bg: '#fee2e2',
    trend: '待处理',
    trendClass: 'neutral',
  },
