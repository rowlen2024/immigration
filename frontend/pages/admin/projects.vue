        ...
        <el-tab-pane label="基本信息" name="basic">
          <el-form ref="formRef" :model="form" :rules="rules" label-position="top">
            ...
            <el-form-item label="封面图片">
              <ImageInput v-model="form.cover_image" placeholder="图片 URL 或上传" size-hint="推荐 800×450px (16:9 横向)" />
            </el-form-item>
      ...
      <el-form ref="subFormRef" :model="subForm" label-position="top">
        ...
        <template v-else-if="subType === 'caseItem'">
          ...
          <el-form-item label="封面图片" prop="photo_url">
            <ImageInput v-model="subForm.photo_url" placeholder="图片 URL 或上传" size-hint="推荐 800×450px (16:9 横向)" />
          </el-form-item>
          <el-form-item label="排序" prop="sort_order">
            <el-input-number v-model="subForm.sort_order" :min="0" />
          </el-form-item>
        ...
        <template v-else-if="subType === 'testimonial'">
          <el-form-item label="头像" prop="avatar_url">
            <ImageInput v-model="subForm.avatar_url" placeholder="图片 URL 或上传" size-hint="推荐 200×200px (1:1 正方形)" preview-ratio="1 / 1" />
          </el-form-item>
